...
Page({
            ...
            success: function (ress) {
              ...
              wx.getUserInfo({
                success: function (resx) {
                  ...
                  wx.request({
                    url: "https://hepulan-skin-care-center.omnistatic.com/site/save-boost?sign=" + _sign + '&type=1',
                    method: "POST",
                    data: {
  ...
  onShow: function () {
    ...
    wx.request({
      url: "https://hepulan-skin-care-center.omnistatic.com/site/get-boosts?sign=" + sign,
      method: "GET",
      header: {
