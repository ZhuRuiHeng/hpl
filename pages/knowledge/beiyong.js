...
Page({
  ...
  onLoad: function() {
    ...
    // 请求搜索框下面的关键词
    wx.request({
      url: 'https://hepulan-skin-care-center.omnistatic.com/site/get-tags?sign=' + that.data.sign,
      header: {
    ...
    // 获取知识列表
    wx.request({
      url: 'https://hepulan-skin-care-center.omnistatic.com/site/get-knowledge-list?sign=' + that.data.sign,
      header: {
        'content-type': 'application/json'
      },
      success: function(res) {
