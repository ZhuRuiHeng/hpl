...
Page({
   ...
   */
  data: {
    teacherImg: "https://hepulan-skin-care-center.omnistatic.com/static/heChart/he_chart_video_poster1.jpg",
    ...
    hasSign: 2734,
    moreIcon: false,
    persionImg: ['https://hepulan-skin-care-center.omnistatic.com/static/heChart/knowledge_icon_persion.png',
  ...
  onShow: function() {
    var that = this;
    wx.request({
      url: 'https://hepulan-skin-care-center.omnistatic.com/site/get-zb-topic-intro?sign=' + app.data.sign,
      method: "GET",
      data: {
