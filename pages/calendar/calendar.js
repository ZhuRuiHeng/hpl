...
Page({
  ...
  calendarSign: function(e) {
    ...
    wx.request({
      url: 'https://hepulan-skin-care-center.omnistatic.com/site/save-punch?sign=' + that.data.sign + '&v=1.1',
      method: "GET",
      data: {
        formId: formId
      },
  ...
  getCoins: function() {
    ...
    // 获取金币
    wx.request({
      url: 'https://hepulan-skin-care-center.omnistatic.com/site/get-coins?sign=' + that.data.sign + '&v=1.1',
      method: "GET",
      success: function(res) {
  ...
  onLoad: function() {
    ...
    // 获取近30天签到列表
    wx.request({
      url: 'https://hepulan-skin-care-center.omnistatic.com/site/get-punchs?sign=' + that.data.sign + '&v=1.1',
      method: "GET",
      success: function(res) {
        // pass
        console.log(res);
