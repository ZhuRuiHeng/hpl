...
Page({
  ...
  data: {
    ...
    videoList:[{
      ...
      videoPoster:'https://hepulan-skin-care-center.omnistatic.com/static/heChart/he_chart_video_poster1.jpg'
    },{
      id:1,
      persion_num:2500,
      videoStatic:"正在直播",
      ...
      videoPoster:'https://hepulan-skin-care-center.omnistatic.com/static/heChart/he_chart_video_poster2.jpg'
    },{
      id:2,
      persion_num:2500,
      videoStatic:"回放中",
  ...
  labelItem:function(ev){
     ...
     wx.request({
      url: 'https://hepulan-skin-care-center.omnistatic.com/site/get-zb-home?sign=' + app.data.sign,
      method:"GET",
      data:{
        keyword:text_world
      },
